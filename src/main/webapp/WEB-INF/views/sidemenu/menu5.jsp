...
<nav>
                    <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu pcoded <c:if test="${ fn:startsWith(path2, '/store/detail') || fn:startsWith(path2, '/store/inOutDetail') || path2 eq '/store/inOutList.do' || path2 eq '/store/listStore.do' || path2 eq '/store/writeStore.do' || path2 eq '/code/writeLoc.do'|| path2 eq '/store/detail.do' || path2 eq '/store/writeInout.do' }">pcoded-trigger</c:if>">
