...
$(document).on('click', '.product-add-btn', function() {
    _ajax_html('/sfa/template/form/monitorapp/op_product_row.tmpl.php', 'type=po', print_product_row, 'po', true);
});
$(document).on('click', '.s-product-add-btn', function() {
    _ajax_html('/sfa/template/form/monitorapp/op_product_row.tmpl.php', 'type=svc', print_product_row, 'svc', true);
});
$(document).on('click', '.m-product-add-btn', function() {
    _ajax_html('/sfa/template/form/monitorapp/op_product_row.tmpl.php', 'type=ma', print_product_row, 'ma', true);
});
