				...
				<div class="card-block table-border-style">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" name="netprice"
										id="productDefaultPrice" class="form-control form-control-sm"
												...
												<c:forEach var="list2" items="${list2}">
													<c:if
														...
														<option class="list3Options" style="display: none;"
															value="${list3.code02}-${list3.code03}">${list3.desc03}</option>
													</c:if>
												</c:forEach>
											</c:forEach>
									</select>
					...
					<div class="btn_wr text-right mt-3">
						...
						<button class="btn btn-md btn-success f-left"
							onClick="javascript:location='${path}/product/list.do'">목록</button>
						<button class="btn btn-md btn-primary"
							onClick="fn_productInsert()" value="등록">등록</button>
					</div>
				</div>
			</div>
		</div>
