                    ...
                    <div class="table-responsive">
                        <table class="table table-sm bst02">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="inout" id ="storeType" class="form-control form-control-sm" >
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="requiredTextCss">상품 기본가격</th>
                                <td>
                                    <input type="text" name="netprice" id ="productDefaultPrice" class="form-control form-control-sm" value="0" style="text-align: right;">
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="requiredTextCss">상품 수량</th>
                                <td>
                                    <input type="text" name="storeqty" id ="storeQty" class="form-control form-control-sm" value="0" style="text-align: right;">
                                </td>
                            </tr>
                            <tr>
